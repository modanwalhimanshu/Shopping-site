<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cart2.aspx.cs" Inherits="cart2" %>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="cart2.aspx">Cart</a></li>
                                    ...
                                    <tbody>
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-name">
                                                ...
                                                <asp:Label ID="lblproductname" runat="server" Text="No Item Added"></asp:Label>
                                            </td>

                                            <td class="product-price">
                                                <span class="amount">
                                                    <asp:Label ID="lblprice" runat="server" Text="00"></asp:Label></span>
                                                ...
                                                <div class="quantity buttons_added">
                                                    <table class="nav-justified">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtquantity" runat="server" Height="30px" MaxLength="1" 
                                            ...
                                            <td class="product-subtotal">
                                                <span class="amount"><asp:Label ID="lbltotalamt" runat="server" Text="00"></asp:Label></span> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="actions" colspan="6">
                                                <asp:Button ID="btncheckout" runat="server" Text="checkout"  OnClientClick="return validate();" CssClass="btn" 
